...
public class ECG extends AppCompatActivity {
    //전역변수
    float ecg_mean = 0;
    float ecg_mean_final = 0;
    int heart_beat_sender = 0;
...
//                                                        Log.d("DKU", "심박수: " + ecg);
                                                    ...
                                                    heart_beat = (int) ecg;
                                                    //heart_beat_sender = (int) ecg;
                                                    ecg = 0;
                                                    if(heart_beat > 50){
                                                        txtV3.setText("Heart Beat: "+heart_beat);
                                                    }

                                                    Log.d("SIMLOG","heart의 가뵤 : "+heart_beat+"\n");

                                                    if(heart_beat>=50 && heart_beat<=150){
                                                        ecg_mean += heart_beat;
                                                        Log.d("SIMLOG","ecg mean값 : "+ecg_mean);
                                                        counter++;
                                                        Log.d("SIMLOG"," : "+counter);
                                                    }
                                                    heart_beat = 0;
//                                                    else{
//                                                        ecg_mean += 60;
...
//                                                    Log.d("DKM","size : "+ queue.size());
                                                    ...
                                                    LineDataSet set1;
                                                    set1 = new LineDataSet(values, "Real-time ECG");
        ...
        finishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //평균 심박수 분석페이지로 넘기기
//                Toast.makeText(getApplicationContext(), "DB로 이동중! 평균심박수는? "+ecg_mean_final, Toast.LENGTH_SHORT).show();
                //Log.d("SIMLOG",""+counter);
                ecg_mean_final = ecg_mean / counter;
                Intent intent = new Intent(ECG.this, State.class);
                intent.putExtra("ecg_mean",ecg_mean_final);
